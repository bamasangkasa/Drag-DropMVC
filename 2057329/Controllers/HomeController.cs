...
namespace _2057329.Controllers
{
  public class HomeController : Controller
  {
    ...
    public JsonResult UploadHandler()
    {
            ...
            //string strTempPath = Server.MapPath("~/Content/");
            //PostedFile.SaveAs(Path.Combine(strTempPath, PostedFile.FileName));
        int jmlRows = 0;
        ...
        if (Request.Files[0].ContentLength > 0)
        {
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                string query = "Insert into Wong(Name,Email,Mobile) Values('" +
        ...
        return Json(new { success = jmlRows + " Rows inserted" });
    }
  }
}